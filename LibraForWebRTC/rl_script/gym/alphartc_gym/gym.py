...
class Gym(object):
    ...
    def reset(
        ...
        # self.gym_id = "gym"+str(random.randint(0,100000))
        print("id:")
        print(self.gym_id)
        print("CAA:{}".format(train_mode))
        self.gym_process = gym_process.GymProcess(
            ...
            start_time,
            episode)
        self.gym_conn = gym_connect.GymConnector(gym_id = self.gym_id)
