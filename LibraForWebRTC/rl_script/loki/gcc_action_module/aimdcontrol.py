...
class Aimd_rate_controller:
    ...
    def __additive_rate_increase(self, cur_ts, last_ts):
        ...
        计算一个在稳定期间的带宽增量
        '''
        # print("cur_ts:"+str(cur_ts)+" last_ts:"+str(last_ts)+" delta:"+str(cur_ts - last_ts)+ " __aimd_get_near_max_inc_rate:"+str(self.__aimd_get_near_max_inc_rate()))
        result = (cur_ts -
    ...
    def __multiplicative_rate_increase(self, cur_ts, last_ts, curr_bitrate):
        ...
        # print("alpha",alpha)
        # print("cur_ts:"+str(cur_ts)+" last_ts:"+str(last_ts)+" delta:"+str(cur_ts - last_ts)+" alpha:"+str(alpha)+" curr_bitrate:"+str(curr_bitrate))

        result = max(curr_bitrate * (alpha - 1.0), 8000.0*(ts_since)/50)
    ...
    def __aimd_change_bitrate(self, new_bitrate, cur_ts):
        ...
        if self.state == kRcHold:
            ...
            # print("increase")
            # print("aimdcontrol.py:incoming_kbitrate:"+str(incoming_kbitrate)+" avg_max_bitrate_kbps:"+str(self.avg_max_bitrate_kbps)+" max_kbitrate"+str(max_kbitrate))
    ...
    def aimd_update(
        ...
        # print("aimd_update:"+str(self.curr_rate))
        return self.curr_rate
