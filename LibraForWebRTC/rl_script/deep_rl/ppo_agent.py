...
class PPO:
    def __init__(self, state_dim, action_dim, exploration_param, lr, betas, gamma, ppo_epoch, ppo_clip, model_path=None, use_gae=False):
        self.lr = lr
        self.betas = betas
        self.gamma = gamma
        ...
        # if(model_path):
        #     print("loaded!")
        self.policy_old.load_state_dict(torch.load(model_path))
